package ipanelonline.mobile.survey.ui.chat.adapter.holder;
...
import ipanelonline.mobile.survey.view.im.BubbleImageView;
import ipanelonline.mobile.survey.view.im.BubbleLinearLayout;
import ipanelonline.mobile.survey.view.im.GifTextView;
...
public class ChatAcceptViewHolder extends BaseViewHolder<MessageInfo> {
    ...
    public void setData(MessageInfo data) {
        ...
        if (data.getContent() != null) {
            ...
            if (len < DeUtils.dp2px(getContext(), 200)){
                layoutParams.width = len + DeUtils.dp2px(getContext(), 30);
            } else {
            ...
            layoutParams.width = DeUtils.dp2px(getContext(), 120);
            layoutParams.height = DeUtils.dp2px(getContext(), 48);
            chatItemLayoutContent.setLayoutParams(layoutParams);
            ...
            chatItemContentImage.setVisibility(View.GONE);
            chatItemVoiceTime.setText(DeUtils.formatTime(data.getVoiceTime()));
