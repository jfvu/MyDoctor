...
import ipanelonline.mobile.survey.ui.chat.adapter.EmotionPagerAdapter;
import ipanelonline.mobile.survey.ui.chat.adapter.holder.EmotionGridViewAdapter;
import ipanelonline.mobile.survey.utils.DeUtils;
import ipanelonline.mobile.survey.utils.EmotionUtils;
import ipanelonline.mobile.survey.utils.GlobalOnItemClickManagerUtils;
import ipanelonline.mobile.survey.view.im.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    private void initEmotion() {
        ...
        // item的间距
        int spacing = DeUtils.dp2px(getActivity(), 12);
        // 动态计算item的宽度和高度
