package ipanelonline.mobile.survey.view.im;
...
import ipanelonline.mobile.survey.utils.AudioRecoderUtils;
import ipanelonline.mobile.survey.utils.DeUtils;
import ipanelonline.mobile.survey.utils.PopupWindowFactory;
...
public class EmotionInputDetector {
    ...
    private OnRecoundListener recoundListener;
    ...
    public EmotionInputDetector bindToAddButton(View addButton, final OnBtnClickListener listener) {
    ...
    public EmotionInputDetector bindToSendButton(View sendButton,final OnBtnClickListener listener) {
    ...
    public EmotionInputDetector bindToVoiceText(TextView voiceText,OnRecoundListener recoundListener) {
        mVoiceText = voiceText;
        this.recoundListener = recoundListener;
    ...
    public EmotionInputDetector build() {
        ...
        mAudioRecoderUtils.setOnAudioStatusUpdateListener(new AudioRecoderUtils.OnAudioStatusUpdateListener() {
            ...
            public void onUpdate(double db, long time) {
                ...
                mTextView.setText(DeUtils.long2String(time));
            }

            //录音结束，filePath为保存路径
            @Override
            public void onStop(long time, String filePath) {
                mTextView.setText(DeUtils.long2String(0));
                MessageInfo messageInfo = new MessageInfo();
                messageInfo.setFilepath(filePath);
                messageInfo.setVoiceTime(time);
                EventBus.getDefault().post(messageInfo);
                if(recoundListener != null){
                    recoundListener.onStop(filePath);
                }
    ...
    public interface OnRecoundListener{
